...
describe('Libro Controller', () => {
    ...
    test('getLibroById deberia obtener un libro', async () => {
        const mockLibro = { id: "1", title: "Libro 1", autor: "Autor 1" };
    ...
    test('createLibro deberia crear un nuevo libro', async () => {
        const mockLibro = { id: "1", title: "Nuevo Libro 1", autor: "Un Autor" };
    ...
    test('updateLibro deberia devolver un error si el libro no existente', async () => {
